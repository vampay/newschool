...
exports.register = async (req, res) => {
  const { email, password, name, surname, major, role } = req.body;
  ...
  try {
    ...
    res.status(201).send("สมัครสมาชิกสำเร็จ"); //หากบันทึกผู้ใช้สำเร็จ201 Createdรหัสสถานะจะถูกส่งไปยังไคลเอนต์พร้อมข้อความ "ผู้ใช้ลงทะเบียนแล้ว"
  } catch (err) {
...
exports.login = async (req, res) => {
  ...
  try {
    ...
    //ตรวจสอบข้อผิดพลาดต่างๆ ที่เกิดขึ้นในระหว่างกระบวนการเข้าสู่ระบบ
